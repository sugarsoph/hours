      ...
      <div className="modal" onClick={e=>e.stopPropagation()}>
        ...
        <div style={{display:"flex", gap:16, alignItems:"flex-start"}}>
              ...
              <div key={l.id} style={{display:"grid", gridTemplateColumns:"1fr 130px 42px", gap:8, alignItems:"center", marginBottom:8}}>
                ...
                <input
                  ...
                  onChange={e=>{
                    ...
                    setDrafts(d=>d.map((x,idx)=> idx===i? {...x,name:v}:x));
                  }}
                />
                ...
                <div style={{display:"flex", alignItems:"center", gap:8}}>
                  ...
                  <input
                    ...
                    onChange={e=>{
                      const v=e.target.value;
                      setDrafts(d=>d.map((x,idx)=> idx===i? {...x,color_hex:v}:x));
                    }}
                  />
                </div>
          ...
          <div style={{width:200}}>
            ...
            {/* 🎨 FIXED PASTEL COLOR WHEEL */}
            <div
              className="pastel-wheel"
              onClick={(e) => {
                ...
                // pastel color: fixed saturation/lightness
                const h = Math.round(deg);
                const s = 60;  // softer saturation
                const l = 80;  // pastel lightness
